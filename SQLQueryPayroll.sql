...
--UC-1-DatabseConnection

CREATE PROCEDURE [dbo].[DatabseConnection]
AS  
BEGIN  
   select * from employee_payroll  
END
...
AS
BEGIN
INSERT INTO employee_payroll VALUES(@name, @basic_pay, @start,@gender)
END
...
AS
BEGIN
UPDATE employee_payroll SET ID = 3, @basic_pay = 5600000.00 WHERE id=@id
END
